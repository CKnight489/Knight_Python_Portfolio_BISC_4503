# Knight_Python_Portfolio_BISC_4503
...
<img width="372" height="253" alt="output_11_0" src="https://github.com/user-attachments/assets/aa03271f-6171-47d3-a042-9a6775d14779" />
...
<img width="435" height="267" alt="output_16_0" src="https://github.com/user-attachments/assets/8ed73545-af35-416e-8c00-23cee4e7211a" />
...
<img width="451" height="267" alt="output_17_0" src="https://github.com/user-attachments/assets/d192f9b8-3ab9-4b95-9725-a03204e732d1" />
...
```python
print('maximum inflammation for patient_2:', numpy.amax(data[2, :]))
```
...
## Python Lists
Learning what lists in Python are and how to create them
...
## Python Loop
Learning what loops look like in Python and how to create them
...
## Using Multiple Files in Python
Learning how to use multiple files in Python coding
...
```
    ...
    inflammation-01.csv
<img width="712" height="208" alt="output_2_1" src="https://github.com/user-attachments/assets/869e5d31-93e7-410c-9319-cd6f5d2474bc" />


    inflammation-02.csv
<img width="712" height="208" alt="output_2_3" src="https://github.com/user-attachments/assets/d5bee5eb-c0f5-45ba-bba8-c4c69cea40d5" />


    inflammation-03.csv
<img width="712" height="208" alt="output_2_5" src="https://github.com/user-attachments/assets/28a92630-7eb1-4370-8a4e-a17c7fbae92f" />

## Making Choices 1
Learned how to code "if/else/elif" in Python
...
```python
def explicit_fahr_to_celsisus(temp):
...
```python
def fahr_to_celsisus(temp):
    # Return converted values more efficiently using the retun function without creating a new variable
...
```python
print('Freezing point of water:', fahr_to_celsisus(32), 'C')
print('Boiling point of water:', fahr_to_celsisus(212), 'C')
```
...
```python
def celsisus_to_kelvin(temp_c):
    return temp_c + 273.15
print('freezing point of water in Kelvin:', celsisus_to_kelvin(0.))
```
...
def fahr_to_Kelvin(temp_f):
    temp_c = fahr_to_celsisus(temp_f)
    temp_k = celsisus_to_kelvin(temp_c)
    return temp_k
...
<img width="712" height="208" alt="output_3_1" src="https://github.com/user-attachments/assets/de94c72a-c4f7-4c50-885b-ceae3525f5c4" />
...
<img width="712" height="208" alt="output_3_3" src="https://github.com/user-attachments/assets/71ced92c-2213-4640-86d1-5f4d7d276cf2" />
...
<img width="712" height="208" alt="output_3_5" src="https://github.com/user-attachments/assets/fe6cad56-2d80-4e6d-bf35-7cc2a344b85b" />
...
```python
print('original min, mean, max are:', numpy.amin(data), numpy.mean(data), numpy.amax(data))
...
```python
def offset_mean(data, target_mean_value):
    """Return a new array containing the orginal data with its mean offset to match desired value"""
    return(data - numpy.mean(data)) + target_mean_value
```
...
```python
def offset_mean(data, target_mean_value):
    """Return a new array containing the original data with its new offset to match the desried value
    Examples
    --------
...
def offset_mean(data, target_mean_value = 0.0):
    """Return a new array containing the original data with its new offset to match the desried value, (0 by default).
